(function() {
  ...
  function setupEventListeners() {
    elements.profileBtns.forEach(function(btn) {
      btn.addEventListener('click', function() {
        ...
        broadcastToTabs('SET_KEEP', { value: keep });
      });
    });
    ...
    elements.modeOptions.forEach(function(opt) {
      opt.addEventListener('click', function() {
        ...
        broadcastToTabs('SET_MODE', { displayMode: mode });
      });
    });
    ...
    elements.confirmUndo.addEventListener('click', function() {
      ...
      broadcastToTabs('SET_KEEP', { value: originalKeep });
      broadcastToTabs('SET_MODE', { displayMode: originalMode });
      hideConfirmBar();
    });
  ...
  // Broadcast settings to all claude.ai tabs
